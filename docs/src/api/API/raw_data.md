...
1.  Post your request here and your request will be on queue, endpoint will return as following:
    {
...
```
Watch upload of s3; either it is completed or not, remove the temp file after completion.
